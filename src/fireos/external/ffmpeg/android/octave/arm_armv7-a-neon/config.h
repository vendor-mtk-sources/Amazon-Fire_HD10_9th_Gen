...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --target-os=android --cc=/media/calvmoon/External/FOS6/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-gcc --cxx=/media/calvmoon/External/FOS6/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-g++ --arch=arm --cpu=armv7-a --extra-cflags=' -isystem /media/calvmoon/External/FOS6/bionic/libc/arch-arm/include -isystem /media/calvmoon/External/FOS6/bionic/libc/include -isystem /media/calvmoon/External/FOS6/bionic/libc/kernel/uapi -isystem /media/calvmoon/External/FOS6/bionic/libc/kernel/common -isystem /media/calvmoon/External/FOS6/bionic/libc/kernel/uapi/asm-arm -isystem /media/calvmoon/External/FOS6/bionic/libm/include -isystem /media/calvmoon/External/FOS6/bionic/libm/include/arm -I/media/calvmoon/External/FOS6/external/zlib' --extra-cxxflags=' -I/media/calvmoon/External/FOS6/vendor/fraunhofer/mpeghLibs/dependencies/include -I/media/calvmoon/External/FOS6/vendor/fraunhofer/mpeghLibs/dependencies/libSYS/include -I/media/calvmoon/External/FOS6/vendor/fraunhofer/mpeghLibs/integration/decoder -I/media/calvmoon/External/FOS6/hardware/libhardware/include -I/media/calvmoon/External/FOS6/system/core/include -I/media/calvmoon/External/FOS6/system/media/audio/include -I/media/calvmoon/External/FOS6/out/target/product/octave/obj/include -I/media/calvmoon/External/FOS6/external/libcxx/include -I/media/calvmoon/External/FOS6/external/libcxxabi/include' --extra-ldflags=-B/media/calvmoon/External/FOS6/out/target/product/octave/obj/lib --prefix=out --disable-symver --disable-stripping --enable-shared --disable-static --enable-pic --disable-doc --disable-avdevice --disable-swscale --disable-postproc --disable-pixelutils --disable-everything --enable-libopus --enable-protocol=file --enable-protocol=http --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mov --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ogg --enable-demuxer=wav --enable-demuxer=flac --enable-demuxer=pcm_f32be --enable-demuxer=pcm_f32le --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s24be --enable-demuxer=pcm_s24le --enable-demuxer=pcm_s32be --enable-demuxer=pcm_s32le --enable-demuxer=pcm_s8 --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --enable-parser=opus --enable-parser=vorbis --enable-parser=flac --enable-decoder=aac --enable-decoder=aac_at --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-decoder=mp3 --enable-decoder=libopus --enable-decoder=vorbis --enable-decoder=flac --enable-decoder=pcm_f16le --enable-decoder=pcm_f24le --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_s24be --enable-decoder=pcm_s24le --enable-decoder=pcm_s32be --enable-decoder=pcm_s32le --enable-decoder=pcm_s8 --enable-decoder=pcm_u8 --enable-encoder=libopus --enable-encoder=flac --enable-muxer=ogg --enable-muxer=flac --enable-filter=volume --enable-filter=aresample --enable-filter=equalizer --enable-acodeca --enable-decoder=libxheaac"
...
#define CONFIG_LIBXHEAAC_DECODER 1
