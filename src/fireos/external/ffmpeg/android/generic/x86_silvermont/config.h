...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --target-os=android --cc='/media/calvmoon/External/FOS5/prebuilts/misc/linux-x86/ccache/ccache /media/calvmoon/External/FOS5/prebuilts/gcc/linux-x86/x86/x86_64-linux-android-4.8/bin/x86_64-linux-android-gcc' --cxx='/media/calvmoon/External/FOS5/prebuilts/misc/linux-x86/ccache/ccache /media/calvmoon/External/FOS5/prebuilts/gcc/linux-x86/x86/x86_64-linux-android-4.8/bin/x86_64-linux-android-g++' --arch=x86 --disable-x86asm --cpu=silvermont --x86asmexe=yasm --extra-cflags='-m32 -isystem /media/calvmoon/External/FOS5/bionic/libc/arch-x86/include -isystem /media/calvmoon/External/FOS5/bionic/libc/include -isystem /media/calvmoon/External/FOS5/bionic/libstdc++/include -isystem /media/calvmoon/External/FOS5/bionic/libc/kernel/uapi -isystem /media/calvmoon/External/FOS5/bionic/libc/kernel/uapi/asm-x86 -isystem /media/calvmoon/External/FOS5/bionic/libm/include -isystem /media/calvmoon/External/FOS5/bionic/libm/include/i387 -I/media/calvmoon/External/FOS5/external/zlib' --extra-cxxflags= --extra-ldflags='-m32 -B/media/calvmoon/External/FOS5/out/target/product/knight/obj/lib' --prefix=out --disable-symver --disable-stripping --enable-shared --disable-static --enable-pic --disable-doc --disable-avdevice --disable-swscale --disable-postproc --disable-pixelutils --disable-everything --enable-libopus --enable-protocol=file --enable-protocol=http --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mov --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ogg --enable-demuxer=wav --enable-demuxer=flac --enable-demuxer=pcm_f32be --enable-demuxer=pcm_f32le --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s24be --enable-demuxer=pcm_s24le --enable-demuxer=pcm_s32be --enable-demuxer=pcm_s32le --enable-demuxer=pcm_s8 --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --enable-parser=opus --enable-parser=vorbis --enable-parser=flac --enable-decoder=aac --enable-decoder=aac_at --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-decoder=mp3 --enable-decoder=libopus --enable-decoder=vorbis --enable-decoder=flac --enable-decoder=pcm_f16le --enable-decoder=pcm_f24le --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_s24be --enable-decoder=pcm_s24le --enable-decoder=pcm_s32be --enable-decoder=pcm_s32le --enable-decoder=pcm_s8 --enable-decoder=pcm_u8 --enable-encoder=libopus --enable-encoder=flac --enable-muxer=ogg --enable-muxer=flac --enable-filter=volume --enable-filter=aresample --enable-filter=equalizer"
...
#define CONFIG_LIBXHEAAC_DECODER 0
