...
extern struct qdisc_util prio_qdisc_util; // fosmod_tc_enable_additional_features
extern struct filter_util u32_filter_util;
extern struct filter_util fw_filter_util; // fosmod_tc_enable_additional_features
#endif
