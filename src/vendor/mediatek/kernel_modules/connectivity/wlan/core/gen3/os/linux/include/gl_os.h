...
#define DEV_TYPE_ID_abc123 0x005E
...
#define ant_placement_abc123 {MAIN_ANT_INDEX, MAIN_ANT_INDEX, SECOND_ANT_INDEX, SECOND_ANT_INDEX}

/*modify for fos7 record the gpio high or low level of the ant */
#define ant_signal_maverick {LOW_ANT_SIGNAL, HIGH_ANT_SIGNAL}
#define ant_signal_abc123 {HIGH_ANT_SIGNAL, LOW_ANT_SIGNAL}
