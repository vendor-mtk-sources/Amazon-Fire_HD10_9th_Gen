...
bool SetAdc2ToAwb2Data(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I17,
...
bool SetI2s2AdcToVul(unsigned int ConnectionState)
{
...
bool SetI2s2Adc2ToVulData2(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I27,
			Soc_Aud_InterConnectionOutput_O21);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I28,
			Soc_Aud_InterConnectionOutput_O22);
	return true;
}
...
static const struct connection_link_t mConnectionLink[] = {
	...
	{Soc_Aud_AFE_IO_Block_I2S2, Soc_Aud_AFE_IO_Block_MEM_VUL, SetI2s2AdcToVul},
	{Soc_Aud_AFE_IO_Block_I2S2_2, Soc_Aud_AFE_IO_Block_MEM_VUL_DATA2, SetI2s2Adc2ToVulData2},
	{Soc_Aud_AFE_IO_Block_ADDA_UL2, Soc_Aud_AFE_IO_Block_MEM_AWB2, SetAdc2ToAwb2Data},
