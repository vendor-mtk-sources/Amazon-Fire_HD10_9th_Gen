...
#ifdef DEBUG_AUD_AWB2
#define PRINTK_AUD_AWB2(format, args...)  pr_debug(format, ##args)
#else
#define PRINTK_AUD_AWB2(format, args...)
#endif
...
#define MT_SOC_AP_DMIC_DAI_NAME "mt-soc-ap-dmic-dai-driver"
...
#define MT_SOC_AP_DMIC_PCM  "mt-soc-ap-dmic-pcm"
...
#define MT_SOC_AP_DMIC_STREAM_NAME "Ap_Dmic_Capture"
