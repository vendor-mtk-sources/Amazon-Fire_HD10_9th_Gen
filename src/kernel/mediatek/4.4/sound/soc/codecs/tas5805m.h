...
//RESET
    { 0x00, 0x00 },
    { 0x7f, 0x00 },
    { 0x03, 0x02 }, 			// Step 2, Change to HiZ mode, and wait 2ms
    { CFG_META_DELAY, 0x02 },
    { 0x01, 0x11 }, 			// Step 3, Reset devices
    { CFG_META_DELAY, 0x14 },	// Step 4, Delay 20ms

    { 0x00, 0x00 },
    { 0x7f, 0x00 },
    { 0x03, 0x02 }, 			// Step 5, Change to HiZ mode, wait 2ms, and go back to Deep sleep
    { CFG_META_DELAY, 0x02 },
    { 0x03, 0x00 },
    { CFG_META_DELAY, 0x14 }, 	// Step 6, 20ms delay (SPK_OUT discharge)
    ...
    { 0x03, 0x02 }, 			// Step 7, Change to HiZ mode, and delay 2ms
    { CFG_META_DELAY, 0x02 },
    { 0x02, 0x02 }, 			// Step 8, Change to Hybrid modulation mode
};

static const struct reg_sequence tas5805m_init_sequence2[] =
{
    { 0x00, 0x00 },
    { 0x00, 0x00 },
    { 0x00, 0x00 },
    ...
    { 0x7f, 0x8c },
    { 0x00, 0x29 },
    { 0x18, 0x00 }, //  Input Mixer Left to left = -0.5 dB
    { 0x19, 0x78 },
    { 0x1a, 0xd6 },
    { 0x1b, 0xfd },
    ...
    { 0x22, 0x00 },
    { 0x23, 0x00 },
    { 0x24, 0x00 }, //  Input Mixer Right to right = -0.5 dB
    { 0x25, 0x78 },
    { 0x26, 0xd6 },
    { 0x27, 0xfd },
    { 0x00, 0x2a },
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x24 },
    { 0x18, 0x07 }, //  Biquad -  BQ1 Left   -     Filter: High Pass-ButterWorth 2  Frequency: 2000 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x19, 0x4a },
    { 0x1a, 0xed },
    { 0x1b, 0xf3 },
    { 0x1c, 0xf1 },
    ...
    { 0x2a, 0x19 },
    { 0x2b, 0xbe },
    { 0x2c, 0x07 }, //  Biquad -  BQ2 Left   -     Filter: High Pass-ButterWorth 2  Frequency: 2000 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x2d, 0x4a },
    { 0x2e, 0xed },
    { 0x2f, 0xf3 },
    { 0x30, 0xf1 },
...
//Register Tuning
    { 0x00, 0x00 },
    { 0x7f, 0x00 },
    { 0x28, 0x30 }, /* 32Fs, auto detect*/
    { 0x33, 0x00 }, /* 16bit */
    { 0x30, 0x01 },
    { 0x4c, 0x30 },
    { 0x5d, 0x98 }, // Dither disable, 3.072M, DEM enable

    { CFG_META_DELAY, 0x05 }, // 5ms delay before programming RC filter

    // DAC filter programming start
    { 0x3a, 0xf9 }, // Enable RC filter
    { 0x3f, 0x0f },
    { 0x00, 0x01 },
    { 0x13, 0x20 },
    { 0x00, 0x00 },
    // DAC filter programming end

    { CFG_META_DELAY, 0x14 }, // 20ms delay before setting for play
