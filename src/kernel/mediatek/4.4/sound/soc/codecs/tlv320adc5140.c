...
static const struct soc_enum adc5140_enum[] = {
	SOC_ENUM_SINGLE(ADC5140_CH1_CFG0, 2, 2, mic_select_text),
	SOC_ENUM_SINGLE(ADC5140_CH2_CFG0, 2, 2, mic_select_text),
	SOC_ENUM_SINGLE(ADC5140_CH3_CFG0, 2, 2, mic_select_text),
	SOC_ENUM_SINGLE(ADC5140_CH4_CFG0, 2, 2, mic_select_text),
	SOC_ENUM_SINGLE(ADC5140_CH1_CFG0, 4, 2, input_config_text),
	SOC_ENUM_SINGLE(ADC5140_CH2_CFG0, 4, 2, input_config_text),
	SOC_ENUM_SINGLE(ADC5140_CH3_CFG0, 4, 2, input_config_text),
	SOC_ENUM_SINGLE(ADC5140_CH4_CFG0, 4, 2, input_config_text),
};
...
static const struct snd_kcontrol_new adc5140_snd_controls_a[] = {
	...
	/* output selection on I2S bus */
	SOC_SINGLE("Ch1 Output A", ADC5140_ASI_CH1, 6, 1, 0),
	SOC_SINGLE("Ch2 Output A", ADC5140_ASI_CH2, 6, 1, 0),
	SOC_SINGLE("Ch3 Output A", ADC5140_ASI_CH3, 6, 1, 0),
	SOC_SINGLE("Ch4 Output A", ADC5140_ASI_CH4, 6, 1, 0),

	/* enable secondly output */
	SOC_SINGLE("Enable Secondary Output A", ADC5140_GPIO_CFG0, 4, 15, 0),
				 ...
				 struct snd_soc_dai *codec_dai)
{
	...
	struct adc5140_priv *adc5140 = snd_soc_codec_get_drvdata(codec);
	u8 wlen = 0, fs_rate = 0, fs_bclk_ratio = 0;
	...
	dev_info(component->dev, "%s: wlen 0x%X fs_rate 0x%X fs_bclk_ratio 0x%X\n",
		__func__, wlen, fs_rate, fs_bclk_ratio);

	snd_soc_component_update_bits(component, ADC5140_ASI_CFG0,
				ADC5140_WORD_LEN_MSK | ADC5140_TX_FILL, wlen |
				ADC5140_TX_FILL);
