...
static struct gc5035sec_otp_t gc5035sec_otp_data;
...
static kal_uint8 gc5035sec_otp_identify(void)
{
	kal_uint8 moduleID = 0;
...
static void gc5035sec_otp_function(void)
{
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("Exit! GC5035SEC_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
